...
if (isset($_POST['reset-request-submit'])) {
 ...
 // Tokens are used to make sure it is the correct user that is trying to reset their password. I will explain more on this later.
  ...
  //$url = "http://adi.ntig.tech/LoginSystem/create-new-password.php?selector=" . $selector . "&validator=" . bin2hex($token);

  $url = "http://localhost:8088/LoginSystem/create-new-password.php?selector=" . $selector . "&validator=" . bin2hex($token);
  ...
  // Subject
  $subject = 'Reset your password for lifetech network';
  ...
  // Headers
  // Headers
  $headers = "From: NTI <arnauddi@adi.ntig.tech>\r\n";
  $headers .= "Reply-To: arnauddi@adi.ntig.tech\r\n";
